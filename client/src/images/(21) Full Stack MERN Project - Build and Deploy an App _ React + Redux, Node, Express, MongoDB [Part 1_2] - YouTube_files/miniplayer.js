...
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Expand");g.X.call(this,{D:"button",ka:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],U:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},S:[d]});this.G=a;this.za("click",this.onClick,this);this.Ba("title",g.cO(a,e,"i"));g.Ri(this,g.AO(b.Qb(),this.element))},z4=function(a){g.X.call(this,{D:"div",
...
this.Ai);this.Ai.fa(this.zj.element);this.cd=new g.aQ(this.player,this);g.I(this,this.cd);g.wN(this.player,this.cd.element,4);this.Au=new g.X({D:"div",K:"ytp-miniplayer-buttons"});g.I(this,this.Au);g.wN(this.player,this.Au.element,4);a=new g.X({D:"button",ka:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Close"},S:[g.GL()]});g.I(this,a);a.fa(this.Au.element);this.N(a.element,"click",this.oj);a=new g.X({D:"button",ka:["ytp-miniplayer-replay-button","ytp-button"],U:{"aria-label":"Close"},
